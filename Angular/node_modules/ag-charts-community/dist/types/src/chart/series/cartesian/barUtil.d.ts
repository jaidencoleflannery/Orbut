...
export declare function updateRect(rect: Rect, config: RectConfig): void;
interface NodeDatum extends Omit<CartesianSeriesNodeDatum, 'yKey' | 'yValue'> {
}
export declare function getRectConfig<Params extends Omit<AgBarSeriesItemStylerParams<any>, 'yKey'>, ExtraParams extends {}>({ datum, isHighlighted, style, highlightStyle, itemStyler, seriesId, ctx: { callbackCache }, ...opts }: {
    datum: NodeDatum;
