import type { AgChartLabelFormatterParams, AgChartLabelOptions, AgSeriesMarkerStyle, AgSeriesMarkerStylerParams, ISeriesMarker } from 'ag-charts-types';
...
export declare abstract class Series<TDatum extends SeriesNodeDatum, TProps extends SeriesProperties<any>, TLabel = TDatum, TContext extends SeriesNodeDataContext<TDatum, TLabel> = SeriesNodeDataContext<TDatum, TLabel>> extends Observable implements ISeries<TDatum, TProps> {
    ...
    getMarkerStyle<TParams>(marker: ISeriesMarker<TParams>, params: TParams & Omit<AgSeriesMarkerStylerParams<TDatum>, 'seriesId'>, defaultStyle?: AgSeriesMarkerStyle): AgSeriesMarkerStyle & {
        size: number;
    };
