 ...
 */
export declare function formatNormalizedPercentage(ratio: number, locale?: string): string;
/**
 * @param percent A number from 0 to 100.
 * @param locale The locale to use to format the number.
 */
export declare function formatPercentage(percent: number, locale?: string): string;
